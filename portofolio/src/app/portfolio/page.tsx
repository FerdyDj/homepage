    ...
    <div className="bg-gray-100 p-4 sm:p-8">
      ...
      <div className="grid md:grid-cols-2 md:grid-rows-2 grid-rows-4 grid-cols-1 gap-2">
        ...
        <div className="flex-row justify-center items-center border border-gray-300 rounded-md">
          ...
          <p className="text-sm px-2 py-2">
            The website I'm building for Molo, a kids' clothing brand, aims to
          ...
          <p className="text-sm px-2 py-2">
            ...
            professional company profile website for Molo, a kids' clothing
            brand. Molo needed an online presence to showcase their product
          ...
          <p className="text-sm px-2 py-2">
            ...
            reflects Molo's brand identity and provides visitors with easy
          ...
          <p className="text-sm px-2 py-2">
            ...
            engaging layout that aligns with Molo&apos;s branding and provides
          ...
          <p className="text-sm px-2 py-2">
            ...
            effectively showcases Molo&apos;s kids' clothing line, company
            ...
            contributing to Molo&apos;s marketing and sales efforts.
          </p>
          <p className="text-sm px-2 py-2">
            <span className="font-semibold">Technologies :</span> React, Next
